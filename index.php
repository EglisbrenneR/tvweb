                    ...
                    <div class="nav-collapse collapse pull-right">
                        <ul class="nav" id="top-navigation">
                           ...
                           <!--<li><a href="#service">Serviços</a></li>--->
                            ...
                            <li><a href="#clients">Inscritos</a></li>
        ...
        <div id="home">
            ...
            <div id="da-slider" class="da-slider">
                ...
                <div class="container">
                    <!-- Start first slide -->
                    <div class="da-slide">
                        <h2 class="fittext2">CAIXINHA DE HISTORIAS</h2>
                        <h4>BRENNER BORGES & CAMILLA LIMA</h4>
                        <p>O programa caixinha de Histórias e um podcast onde temos o intuito de passar para pessoas que nos acompanham Histórias de superação e vamos contar um pouco da sua trajetória.</p>
                        <a href="https://www.youtube.com/watch?v=i9bNSLCkB3Y&list=PLMAFkvLp105log21KQCj4mDcCoMRKlkIW" class="da-link button">Conheçer</a>
                        <div class="da-img">
                            <img src="images/Slider01.png" alt="image01" width="400">
                        </div>
                    </div>
                    <!-- End first slide -->
                    <!-- Start second slide -->
                    <div class="da-slide">
                        ...
                        <h4>JOSE BORGES</h4>
                        <p>Programa Fique Por Dentro tras Noticias sobre Todo o Esporte.<br>
                           Segunda a Sexta  as 12:00 Horas.
                        </p>
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                            <img src="images/Slider02.png" width="700" alt="image02">
                        </div>
                    </div>
                    <!-- End second slide -->
                    <!-- Start third slide -->
                    <div class="da-slide">
                        <h2>MISSAS E ADORAÇÕES</h2>
                        <h4>PAROQUIA SÃO FRANCISCO DE ASSIS</h4>
                        <p>A Tv Web Esperança trasmite todas as Missas e Adorações da Paroquia São Francisco de assis<br>
                            Quintas as 18:30: Missa e Adoração.<br>
                            Domingo as 07:00 Missa e as 18:30 Missa.
                        </p>
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                            <img src="images/Slider03.png" width="800" alt="image03">
                        </div>
                    </div>
                    <!-- Start third slide -->
        ...
        <div class="section secondary-section " id="portfolio">
            ...
            <div class="container">
                <div class=" title">
                    ...
                    <p>Fique por dentro das ultimas Noticias.</p>
                </div>
                <ul class="nav nav-pills">
                    <li class="filter" data-filter="all">
                        <a href="#noAction">ULTIMAS NOTICIAS</a>
                    </li>
                    <li class="filter" data-filter="web">
                        <a href="noticias.php">TODAS AS NOTICIAS</a>
                    </li>
                </ul>
                <div id="single-project">
                        ...
                        <div class="span6">
                            <div class="project-description">
                                ...
                                <div class="project-info">
                                    <div>
                                        <span>YOUTUBE</span>https://www.youtube.com/watch?v=npxEiGhUjaE</div>
                                    <div>
                                        <span>INSTA</span>https://www.instagram.com/horaciofigueiredo2208/</div>
                                </div>
                                <p>Horacio contou um pouco da sua missão como sacerdócio, ele e seminariasta do seminario da cidade de crato. natural de Barro ceara mais mora no seminario de Quixada ceará onde ta no curso de teólogia </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="slidingDiv1" class="toggleDiv row-fluid single-project">
                        ...
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                                    <h3>PROGRAMA FIQUE POR DENTRO</h3>
                                    <span class="show_hide close">
                                        <i class="icon-cancel"></i>
                                    </span>
                                </div>
                                <div class="project-info">
                                    <div>
                                        <span>YOUTUBE</span>https://www.youtube.com/watch?v=2e5EuTPeLU8</div>
                                    <div>
                                        <span>INSTA</span>https://www.instagram.com/jose_borgesbs/</div>
                                </div>
                                <p>Programa Fique Por Dentro tras Noticias sobre Todo o Esporte.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="slidingDiv2" class="toggleDiv row-fluid single-project">
                        ...
                        <div class="span6">
                            <div class="project-description">
                                ...
                                <p>A Tv Web Esperança trasmite todas as Missas e Adorações da Paroquia São Francisco de assis<br>
                            Quintas as 18:30: Missa e Adoração.<br>
                            Domingo as 07:00 Missa e as 18:30 Missa.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul id="portfolio-grid" class="thumbnails row">
                        <li class="span4 mix web">
                            <div class="thumbnail">
                                ...
                                <h3>PROGRAMA CAIXINHA DE HISTORIAS</h3>
                                <p>ENTREVISTA HORACIO</p>
                                <div class="mask"></div>
                            </div>
                        </li>
                        ...
                        <li class="span4 mix identity">
                            <div class="thumbnail">
                                ...
                                <h3>MISSA E ADORAÇÃO</h3>
                                <p>PAROQUIA SÃO FRANCISCO DE ASSIS</p>
                                <div class="mask"></div>
                            </div>
                        </li>
                    </ul>
